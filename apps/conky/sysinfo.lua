...
conky.text = [[
    ${offset 18}${font Cascadia Code:pixelsize=23}${color0}------------- ${font Cascadia Code:bold:pixelsize=23}${color0}SYSTEM${font Cascadia Code:pixelsize=23}${color0} --------------
    ...
    ${offset -2}${font Cascadia Code:pixelsize=23}${color0}------------- ${font Cascadia Code:bold:pixelsize=23}${color0}NETWORK${font Cascadia Code:pixelsize=23}${color0} -------------
    ...
    ${offset -5}${font Cascadia Code:pixelsize=15}${color0}Downloaded: ${totaldown wlp3s0} ${alignr}${font Cascadia Code:bold:pixelsize=15}${color0}Uploaded: ${totalup wlp3s0}

    ${font Cascadia Code:pixelsize=23}${color0}------------ ${font Cascadia Code:bold:pixelsize=23}${color0}PROCESSORS${font Cascadia Code:pixelsize=23}${color0} -----------
    ${offset -20}${font Cascadia Code:pixelsize=15}${color0}Core1: ${cpu cpu1}% (${freq 1}MHz)${alignr}${cpubar cpu1 7, 250}
    ${offset -5}${font Cascadia Code:pixelsize=15}${color0}Core2: ${cpu cpu2}% (${freq 2}MHz)${alignr}${cpubar cpu2 7, 250}
    ${offset -5}${font Cascadia Code:pixelsize=15}${color0}Core3: ${cpu cpu3}% (${freq 3}MHz)${alignr}${cpubar cpu3 7, 250}
    ${offset -5}${font Cascadia Code:pixelsize=15}${color0}Core4: ${cpu cpu4}% (${freq 4}MHz)${alignr}${cpubar cpu4 7, 250}
    ${offset -5}${font Cascadia Code:pixelsize=15}${color0}Core5: ${cpu cpu5}% (${freq 5}MHz)${alignr}${cpubar cpu5 7, 250}
    ${offset -5}${font Cascadia Code:pixelsize=15}${color0}Core6: ${cpu cpu6}% (${freq 6}MHz)${alignr}${cpubar cpu6 7, 250}
    ${offset -5}${font Cascadia Code:pixelsize=15}${color0}Core7: ${cpu cpu7}% (${freq 7}MHz)${alignr}${cpubar cpu7 7, 250}
    ${offset -5}${font Cascadia Code:pixelsize=15}${color0}Core8: ${cpu cpu8}% (${freq 8}MHz)${alignr}${cpubar cpu8 7, 250}

    ${font Cascadia Code:pixelsize=23}${color0}-------------- ${font Cascadia Code:bold:pixelsize=23}${color0}MEMORY${font Cascadia Code:pixelsize=23}${color0} -------------
    ...
    ${font Cascadia Code:pixelsize=23}${color0}------------ ${font Cascadia Code:bold:pixelsize=23}${color0}PROCESSES${font Cascadia Code:pixelsize=23}${color0} ------------
